...
async function transfer_in(principal, Tokens) {
    try {
...
async function totalSupplyNFT() {
    try {
        var result = await actor_NFT_MM.totalSupplyDip721();
     //	console.log("NFT_MM list: " + list);
		return result;
    } catch (error) {
        console.error('Error getting result:', error);
...
async function totalSupplyNormalNFT() {
    try {
        var result = await actor_NFT_MM.totalSupplyNormalCustom();
     //	console.log("NFT_MM list: " + list);
		return result;
    } catch (error) {
        console.error('Error getting result:', error);
...
async function totalSupplyRareNFT() {
    try {
        var result = await actor_NFT_MM.totalSupplyRareCustom();
     //	console.log("NFT_MM list: " + list);
		return result;
    } catch (error) {
        console.error('Error getting result:', error);
...
async function totalSupplyEpicNFT() {
    try {
        var result = await actor_NFT_MM.totalSupplyEpicCustom();
     //	console.log("NFT_MM list: " + list);
		return result;
    } catch (error) {
        console.error('Error getting result:', error);
...
async function totalSupplyUniqueNFT() {
    try {
        var result = await actor_NFT_MM.totalSupplyUniqueCustom();
     //	console.log("NFT_MM list: " + list);
		return result;
    } catch (error) {
        console.error('Error getting result:', error);
...
async function totalSupplyLegendaryNFT() {
    try {
        var result = await actor_NFT_MM.totalSupplyLegendaryCustom();
     //	console.log("NFT_MM list: " + list);
		return result;
    } catch (error) {
        console.error('Error getting result:', error);
...
document.addEventListener("DOMContentLoaded", async function() {
	...
	window.addEventListener('message', async function(event) {
		...
		} else if (event.data.mode === 'transferIn') {
			const amount = event.data.amount;
		    transfer_in(principal_user, amount).then(function(result) {
				const data = {
					status: 'transferIn',
					result: result,
					amount: amount,
		...
		//	const totalSupplyDip721			 = await totalSupplyNFT();
		...
		//		totalSupplyDip721: totalSupplyDip721,
