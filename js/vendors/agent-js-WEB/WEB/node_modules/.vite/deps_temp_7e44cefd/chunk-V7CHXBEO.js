...
var _Observable_instances;
var _Observable_call;
var _ObservableLog_instances;
var _ObservableLog_call;
var Observable = class extends Function {
  constructor() {
    super();
    _Observable_instances.add(this);
    this.observers = [];
    return new Proxy(this, {
      apply: (target, _, args) => __classPrivateFieldGet3(target, _Observable_instances, "m", _Observable_call).call(target, args[0], ...args.slice(1))
    });
  }
  subscribe(func) {
...
_Observable_instances = /* @__PURE__ */ new WeakSet(), _Observable_call = function _Observable_call2(message, ...rest) {
...
var ObservableLog = class extends Observable {
  constructor() {
    ...
    return new Proxy(this, {
      apply: (target, _, args) => __classPrivateFieldGet3(target, _ObservableLog_instances, "m", _ObservableLog_call).call(target, args[0], ...args.slice(1))
    });
  }
  log(message, ...rest) {
...
_ObservableLog_instances = /* @__PURE__ */ new WeakSet(), _ObservableLog_call = function _ObservableLog_call2(message, ...rest) {
...
var ExponentialBackoff = class _ExponentialBackoff {
  ...
  get ellapsedTimeInMsec() {
    return __classPrivateFieldGet4(this, _ExponentialBackoff_date, "f").now() - __classPrivateFieldGet4(this, _ExponentialBackoff_startTime, "f");
  }
  get currentInterval() {
    return __classPrivateFieldGet4(this, _ExponentialBackoff_currentInterval, "f");
  }
  get count() {
    return __classPrivateFieldGet4(this, _ExponentialBackoff_count, "f");
  }
  get randomValueFromInterval() {
    const delta = __classPrivateFieldGet4(this, _ExponentialBackoff_randomizationFactor, "f") * __classPrivateFieldGet4(this, _ExponentialBackoff_currentInterval, "f");
    const min = __classPrivateFieldGet4(this, _ExponentialBackoff_currentInterval, "f") - delta;
    const max = __classPrivateFieldGet4(this, _ExponentialBackoff_currentInterval, "f") + delta;
    return Math.random() * (max - min) + min;
  }
  incrementCurrentInterval() {
    var _a2;
    __classPrivateFieldSet3(this, _ExponentialBackoff_currentInterval, Math.min(__classPrivateFieldGet4(this, _ExponentialBackoff_currentInterval, "f") * __classPrivateFieldGet4(this, _ExponentialBackoff_multiplier, "f"), __classPrivateFieldGet4(this, _ExponentialBackoff_maxInterval, "f")), "f");
    __classPrivateFieldSet3(this, _ExponentialBackoff_count, (_a2 = __classPrivateFieldGet4(this, _ExponentialBackoff_count, "f"), _a2++, _a2), "f");
    return __classPrivateFieldGet4(this, _ExponentialBackoff_currentInterval, "f");
  }
  next() {
    if (this.ellapsedTimeInMsec >= __classPrivateFieldGet4(this, _ExponentialBackoff_maxElapsedTime, "f") || __classPrivateFieldGet4(this, _ExponentialBackoff_count, "f") >= __classPrivateFieldGet4(this, _ExponentialBackoff_maxIterations, "f")) {
      return null;
    } else {
...
var HttpAgent = class _HttpAgent {
  constructor(options = {}) {
    ...
    _HttpAgent_verifyQueryResponse.set(this, (queryResponse, subnetStatus) => {
      if (__classPrivateFieldGet5(this, _HttpAgent_verifyQuerySignatures, "f") === false) {
      ...
      for (const sig of signatures) {
        ...
        const separatorWithHash = concat(domainSeparator2, new Uint8Array(hash));
    ...
    const defaultBackoffFactory = () => new ExponentialBackoff({
      maxIterations: __classPrivateFieldGet5(this, _HttpAgent_retryTimes, "f")
    });
  ...
  get waterMark() {
    return __classPrivateFieldGet5(this, _HttpAgent_waterMark, "f");
  }
  isLocal() {
  ...
  addTransform(type, fn, priority = fn.priority || 0) {
    if (type === "update") {
      const i = __classPrivateFieldGet5(this, _HttpAgent_updatePipeline, "f").findIndex((x) => (x.priority || 0) < priority);
      __classPrivateFieldGet5(this, _HttpAgent_updatePipeline, "f").splice(i >= 0 ? i : __classPrivateFieldGet5(this, _HttpAgent_updatePipeline, "f").length, 0, Object.assign(fn, { priority }));
    } else if (type === "query") {
      const i = __classPrivateFieldGet5(this, _HttpAgent_queryPipeline, "f").findIndex((x) => (x.priority || 0) < priority);
      __classPrivateFieldGet5(this, _HttpAgent_queryPipeline, "f").splice(i >= 0 ? i : __classPrivateFieldGet5(this, _HttpAgent_queryPipeline, "f").length, 0, Object.assign(fn, { priority }));
    }
  }
  async getPrincipal() {
    if (!this._identity) {
  ...
  async call(canisterId, options, identity) {
    ...
    const backoff2 = __classPrivateFieldGet5(this, _HttpAgent_backoffStrategy, "f").call(this);
    const request2 = __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetry).call(this, {
  ...
  async query(canisterId, fields, identity) {
    ...
    const makeQuery = async () => {
      ...
      return await __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetryQuery).call(this, args);
    };
    const getSubnetStatus = async () => {
      if (!__classPrivateFieldGet5(this, _HttpAgent_verifyQuerySignatures, "f")) {
        return void 0;
      }
      const subnetStatus2 = __classPrivateFieldGet5(this, _HttpAgent_subnetKeys, "f").get(ecid.toString());
      if (subnetStatus2) {
        return subnetStatus2;
      }
      await this.fetchSubnetKeys(ecid.toString());
      return __classPrivateFieldGet5(this, _HttpAgent_subnetKeys, "f").get(ecid.toString());
    };
    ...
    try {
      return __classPrivateFieldGet5(this, _HttpAgent_verifyQueryResponse, "f").call(this, query, subnetStatus);
    } catch (_) {
      this.log.warn("Query response verification failed. Retrying with fresh subnet keys.");
      __classPrivateFieldGet5(this, _HttpAgent_subnetKeys, "f").delete(canisterId.toString());
      await this.fetchSubnetKeys(ecid.toString());
      const updatedSubnetStatus = __classPrivateFieldGet5(this, _HttpAgent_subnetKeys, "f").get(canisterId.toString());
      if (!updatedSubnetStatus) {
        throw new CertificateVerificationError("Invalid signature from replica signed query: no matching node key found.");
      }
      return __classPrivateFieldGet5(this, _HttpAgent_verifyQueryResponse, "f").call(this, query, updatedSubnetStatus);
    }
  }
  ...
  async readState(canisterId, fields, identity, request2) {
    ...
    const backoff2 = __classPrivateFieldGet5(this, _HttpAgent_backoffStrategy, "f").call(this);
    const response = await __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetry).call(this, {
...
`);
  ...
  async syncTime(canisterId) {
    const CanisterStatus = await import("./canisterStatus-QJL2PJHU.js");
  ...
  async fetchSubnetKeys(canisterId) {
    ...
    if (subnetResponse && typeof subnetResponse === "object" && "nodeKeys" in subnetResponse) {
      __classPrivateFieldGet5(this, _HttpAgent_subnetKeys, "f").set(effectiveCanisterId.toText(), subnetResponse);
  ...
  _transform(request2) {
    ...
    if (request2.endpoint === "call") {
      for (const fn of __classPrivateFieldGet5(this, _HttpAgent_updatePipeline, "f")) {
        p = p.then((r) => fn(r).then((r2) => r2 || r));
      }
    } else {
      for (const fn of __classPrivateFieldGet5(this, _HttpAgent_queryPipeline, "f")) {
        p = p.then((r) => fn(r).then((r2) => r2 || r));
      }
    }
    return p;
...
_HttpAgent_retryTimes = /* @__PURE__ */ new WeakMap(), _HttpAgent_backoffStrategy = /* @__PURE__ */ new WeakMap(), _HttpAgent_waterMark = /* @__PURE__ */ new WeakMap(), _HttpAgent_queryPipeline = /* @__PURE__ */ new WeakMap(), _HttpAgent_updatePipeline = /* @__PURE__ */ new WeakMap(), _HttpAgent_subnetKeys = /* @__PURE__ */ new WeakMap(), _HttpAgent_verifyQuerySignatures = /* @__PURE__ */ new WeakMap(), _HttpAgent_verifyQueryResponse = /* @__PURE__ */ new WeakMap(), _HttpAgent_instances = /* @__PURE__ */ new WeakSet(), _HttpAgent_requestAndRetryQuery = async function _HttpAgent_requestAndRetryQuery2(args) {
  ...
  if (delay === null) {
    throw new AgentError(`Timestamp failed to pass the watermark after retrying the configured ${__classPrivateFieldGet5(this, _HttpAgent_retryTimes, "f")} times. We cannot guarantee the integrity of the response since it could be a replay attack.`);
  }
  if (delay > 0) {
...
`, {
    ...
    if (tries < __classPrivateFieldGet5(this, _HttpAgent_retryTimes, "f")) {
      this.log.warn(`Caught exception while attempting to make query:
  ${error}
  Retrying query.`);
      return await __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetryQuery2).call(this, Object.assign(Object.assign({}, args), { tries: tries + 1 }));
    }
    throw error;
  }
  ...
  try {
    ...
    if (__classPrivateFieldGet5(this, _HttpAgent_retryTimes, "f") > tries) {
      this.log.warn(`Caught exception while attempting to make request:
  ${error}
  Retrying request.`);
      return await __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetry2).call(this, { request: request2, backoff: backoff2, tries: tries + 1 });
    }
    throw error;
  }
  if (response.ok) {
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-V7CHXBEO.js.map
