...
if ( $return_url == "" ) $return_url = $HOST . ".aurorahunt.xyz";
...
setcookie('login_id', '', time()-3600, "/", ".aurorahunt.xyz");
setcookie('name', '', time()-3600, "/", ".aurorahunt.xyz");
...
setcookie('m_finalPMW', '', time()-3600,"/",".aurorahunt.xyz");
