...
//		$code_day = $code_info['code'];
		...
		setcookie('hash', AES128Encrypt("Aurorahunt", $login_id."|".$time."|CSVersion:221019"), time() + 60 * 60 * 24, "/", ".aurorahunt.xyz");	
